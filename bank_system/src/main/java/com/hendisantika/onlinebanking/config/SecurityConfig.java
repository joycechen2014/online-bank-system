 ...
 * hendisantika@gmail.com Telegram : @hendisantika34 Date: 04/09/18 Time: 06.29 To change this
...
//                antMatchers("/**").
    ...
    http
        ...
        .formLogin().failureUrl("/index?error").defaultSuccessUrl("/userFront").loginPage("/index")
        .permitAll()
        .and()
